      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="<?php echo base_url('admin/rwirausaha') ?>" class="nav-link <?php if($a == "Rwirausaha") echo "active"; ?>">
          ...
          <li class="nav-item has-treeview">
            <a href="<?php echo base_url('admin/rpekerjaan') ?>" class="nav-link  <?php if($a == "Rpekerjaan") echo "active"; ?>">
